    ...
    return(     
      <Router>
        <Switch>
          ...
          <Route exact path="/action-required" component={ActionRequiredContainer}/>
          <Route exact path="/back-to-inbox" component={BackToInboxContainer}/>
          <Route exact path="/gender" component={GenderContainer}/>
          <Route exact path="/informed-consent" component={InformedConsentContainer}/>
          <Route exact path="/messages" component={MessagesContainer}/>
          <Route exact path="/message-your-doctor" component={MessageYourDoctorContainer}/>
